...
use WellnessCoreBundle\Entity\Surfer;
...
class RegistrationController extends baseController
{
    public function registerAction(Request $request)
    {
        ...
        */
        ...
        if ($form->isValid()) {
             /*$typeUser = $form->getData()->getTypeuser();
                if ($typeUser === "Prestataire")
                {
                    ...
                    $user->setUsertype('prestataire');
                }
                else
                {
                    $user->setRoles(array('ROLE_MEMBRE'));
                    $user->setUsertype('membre');
                }*/
        ...
        return $this->render('AnnuaireAnnuaireBundle:Registration:register2.html.twig', array(
